...
func (a *Aria2) GetVersion() (res *client.VersionInfo, err error) {
	var result client.VersionInfo
...
func (a *Aria2) GetSessionInfo() (res *client.SessionInfo, err error) {
	var result client.SessionInfo
...
func (a *Aria2) TellStatus(gid string, keys []string) (res *client.StatusInfo, err error) {
	var result client.StatusInfo
...
func (a *Aria2) TellActive(keys []string) (res []*client.StatusInfo, err error) {
	var result []*client.StatusInfo
...
func (a *Aria2) TellWaiting(offset, num int, keys []string) (res []*client.StatusInfo, err error) {
	var result []*client.StatusInfo
...
func (a *Aria2) TellStopped(offset, num int, keys []string) (res []*client.StatusInfo, err error) {
	var result []*client.StatusInfo
...
func (a *Aria2) TellFailed(offset, num int, keys []string) (res []*client.StatusInfo, err error) {
	data, err := a.TellStopped(offset, num, keys)
	var results []*client.StatusInfo
...
func (a *Aria2) TellCompleted(offset, num int, keys []string) (res []*client.StatusInfo, err error) {
	data, err := a.TellStopped(offset, num, keys)
...
func FilterResult(info []*client.StatusInfo) []*client.StatusInfo {
	var results []*client.StatusInfo
